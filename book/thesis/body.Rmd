\listofsymbols
\makenicesymbolline {{\bf Abbreviations}}{~}
\makenicesymbolline {ASL}{above sea level}
\makenicesymbolline {DOY}{day of the year: Jan. 1 = 1}
\makenicesymbolline {EBC}{energy balance closure}
\makenicesymbolline {ET}{evapotranspiration}
\makenicesymbolline {EV}{evaporation}
\makenicesymbolline {GPP}{gross primary productivity}
\makenicesymbolline {IA}{index of agreement}
\makenicesymbolline {LAI}{leaf area index}
\makenicesymbolline {MAE}{mean average error}
\makenicesymbolline {NEE}{net ecosystem exchange of carbon dioxide}
\makenicesymbolline {NRMSE}{normalized root mean square error}
\makenicesymbolline {NSeff}{Nash-Sutcliffe model efficiency coefficient}
\makenicesymbolline {PM}{Penman-Monteith}
\makenicesymbolline {PPFD}{photosynthetic photon flux density}
\makenicesymbolline {PT}{Priestley-Taylor}
\makenicesymbolline {RH}{relative humidity}
\makenicesymbolline {RMSE}{root mean square error}
\makenicesymbolline {rSD}{relative standard deviation}
\makenicesymbolline {SD}{standard deviation}
\makenicesymbolline {SE}{standard error}
\makenicesymbolline {TR}{transpiraiton}
\makenicesymbolline {VPD}{vapour pressure deficit}
